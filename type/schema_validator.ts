import { DataPath } from '../core/compilation/compilation_typings.ts';
import { PROP_DATA_PATH } from '../misc/constants.ts';
import { Constructor } from '../misc/typings.ts';
import { Print } from '../util/print_token.ts';
